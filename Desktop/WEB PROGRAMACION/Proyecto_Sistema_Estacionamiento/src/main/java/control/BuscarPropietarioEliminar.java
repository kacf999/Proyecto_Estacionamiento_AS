...
@WebServlet("/BuscarPropietarioEliminar")
public class BuscarPropietarioEliminar extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (propietario != null) {
            ...
            request.getRequestDispatcher("eliminarPropietario.jsp").forward(request, response);
        } else {
