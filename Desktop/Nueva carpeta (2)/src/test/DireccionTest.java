...
public class DireccionTest {
    ...
    void testToString() {
        Direccion direccion = new Direccion("Calle de Prueba 123", "Colonia Prueba", "Delegación Prueba", 1, 12345);
        String expectedString = "Direccion{calle='Calle de Prueba 123', colonia='Colonia Prueba', delegacion='Delegación Prueba', numero=1, cp=12345}";
        assertEquals(expectedString, direccion.toString());
    }
}
